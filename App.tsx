      ...
      if (hasApiKey) {
        ...
        fetchEnrichmentData(term).then((enrichmentData) => {
          setData(prevData => {
            ...
            // Safely merge derivatives
            const prevDerivs = prevData.derivatives || { base: prevData.word, noun: "N/A", verb: "N/A", adjective: "N/A", adverb: "N/A" };
            const newDerivs = (enrichmentData.derivatives || {}) as any;

            const mergedDerivatives = {
               base: prevDerivs.base,
               noun: (prevDerivs.noun === "N/A" && newDerivs.noun && newDerivs.noun !== "N/A") ? newDerivs.noun : prevDerivs.noun,
               verb: (prevDerivs.verb === "N/A" && newDerivs.verb && newDerivs.verb !== "N/A") ? newDerivs.verb : prevDerivs.verb,
               adjective: (prevDerivs.adjective === "N/A" && newDerivs.adjective && newDerivs.adjective !== "N/A") ? newDerivs.adjective : prevDerivs.adjective,
               adverb: (prevDerivs.adverb === "N/A" && newDerivs.adverb && newDerivs.adverb !== "N/A") ? newDerivs.adverb : prevDerivs.adverb,
            };
