        ...
        <div className="flex items-start justify-between mb-6">
          ...
          <div className="flex items-center gap-2">
            <a 
              ...
              className="p-3 bg-slate-800/50 rounded-2xl text-slate-400 backdrop-blur-sm border border-slate-700/50 hover:bg-slate-700/50 hover:text-white transition-colors"
